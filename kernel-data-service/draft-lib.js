...
${nowPlayingLine}${releaseDateLine}      genres: ${JSON.stringify(data.genres)},
      ...
      rottenTomatoes: ${data.rottenTomatoes != null ? data.rottenTomatoes : "null"},
      ...
      trailer: ${data.trailer ? JSON.stringify({
        key: data.trailer.key,
        name: data.trailer.name,
        type: data.trailer.type,
        ...(data.trailer.viewCount != null ? { viewCount: data.trailer.viewCount } : {}),
        ...(data.trailer.likeCount != null ? { likeCount: data.trailer.likeCount } : {}),
        ...(data.trailer.commentCount != null ? { commentCount: data.trailer.commentCount } : {}),
      }) : "null"},
      keywords: ${JSON.stringify(data.keywords || [])},
      watchProviders: ${data.watchProviders ? JSON.stringify(data.watchProviders) : "null"},
      collectionId: ${data.collectionId != null ? data.collectionId : "null"},
      collectionName: ${data.collectionName ? JSON.stringify(data.collectionName) : "null"},
      originalLanguage: ${data.originalLanguage ? JSON.stringify(data.originalLanguage) : "null"},
      productionCountries: ${JSON.stringify(data.productionCountries || [])},
      runtimeMinutes: ${data.runtimeMinutes != null ? data.runtimeMinutes : "null"},
